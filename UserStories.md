...
9. [x] Provide way to remove user access asap if needed
...
18. [x] Only Managers and Admins can accesss User Settings
19. [x] Only Manageres and Admins can create new users
